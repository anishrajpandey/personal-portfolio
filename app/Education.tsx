          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 relative overflow-hidden group">
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-[#008074] text-sm font-medium mb-2">
                  Officer
                </p>
                <p className="text-gray-600 text-sm">
                  Supported technology-focused community initiatives by
                  organizing coding workshops and outreach events. Assisted in
                  mentoring students and helping expand access to tech
                  education.
                </p>
              </div>
            </div>
